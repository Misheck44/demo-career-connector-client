...
const Recruiter = () => {
    const {
        ...
        queryFn: async () => {
            const response = await axios.get(
                `https://demo-career-connector-server.vercel.app/api/v1/application/recruiter-jobs`,
                {
    ...
    const handleAcceptStatus = (id, recruiterId) => {
        ...
        updateJobStatusMutation.mutate({
            body: newStatus,
            url: `https://demo-career-connector-server.vercel.app/api/v1/application/${id}`,
        });
    };
