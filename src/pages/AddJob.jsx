    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await axios.post(
                "https://demo-career-connector-server.vercel.app/api/v1/jobs",
                newJob,
                {
                        ...
                        <div className="form">
                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    {...register("position", {
                                        required: {
                                            value: true,
                                            message: "Internship Position is required",
                                        },
                                        maxLength: {
                                            value: 100,
                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    id="contact"
                                    name="contact"
                                    placeholder="Internship Contact"
                                    {...register("contact", {
                                        required: {
                                            value: true,
